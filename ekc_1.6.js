...
function noActive(){
 ...
 function feedback(){
     ...
     feedback.forEach( function (element){
         element.classList.add('feedback__visible');
     })
 }
 ...
 function noFeedback(){
     let feedback = document.querySelectorAll('.feedback');
     feedback.forEach( function (element){
         element.classList.remove('feedback__visible');
     })
 }
 ...
 function call(){
     ...
     call.forEach( function (element){
         element.classList.add('call__visible');
     })
 }
 ...
 function noCall(){
     let call = document.querySelectorAll('.call');
     call.forEach( function (element){
         element.classList.remove('call__visible');
     })
 }